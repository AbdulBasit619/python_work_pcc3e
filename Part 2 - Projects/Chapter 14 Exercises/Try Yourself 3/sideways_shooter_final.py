...
from sideways_scoreboard import Scoreboard
...
class SidewaysShooter:
    ...
    def _check_play_button(self, mouse_pos):
        """Start a new game when a player wants to play."""
        ...
        if button_clicked and not self.game_active:
            ...
            # Create and empty fleet and center the ship.
            self._create_fleet()
    ...
    def _rocket_hit(self):
        ...
        if self.stats.rockets_left > 0:
            # Decrement rockets left and update the scoreboard.
    ...
    def _create_fleet(self):
        ...
        current_x = self.settings.screen_width - 8 * alien_width
        current_y = alien_height

        while current_x > 30 * alien_width:
