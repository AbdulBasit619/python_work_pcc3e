...
from task_2_settings import Settings
from rectangle import Rectangle
from task_2_rocket import Rocket
from task_2_bullet import Bullet
from task_2_button import Button


class Game:
    """Overall class to manage the game."""

    # Create a rectangle at the right edge of the screen
    # that moves up and down at a steady rate. Then on the left side of the
    # screen, create a rocket that the player can move up and down while firing
    # bullets at the rectangular target. Add a Play button that starts the game,
    ...
    def _update_rectangle(self):
        """Check edges, and move the rectangle accordingly."""
